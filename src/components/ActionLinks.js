    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <a href="https://myshopify.com" target="_blank" rel="noopener noreferrer" className="btn btn-outline" style={{ fontSize: '14px', padding: '10px 20px' }}>
                    Merch
                </a>

                <a href="https://tix.is" target="_blank" rel="noopener noreferrer" className="btn btn-outline" style={{ fontSize: '14px', padding: '10px 20px' }}>
                    Whiskey School
                </a>
            </div>
        </div>
